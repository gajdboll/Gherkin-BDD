...
// getCellData i deprecated 
/*that should be used in case of resolving that issue	@SuppressWarnings("deprecation")*/
	public static String getCellData(int RowNum, int ColNum) throws Exception {
		String retVal;
		Cell = ExcelWSheet.getRow(RowNum).getCell(ColNum);
	//	switch (Cell.getCellData()) { original line - but methot is no longer in use - I re[;laced with existing but wrong method - check below
